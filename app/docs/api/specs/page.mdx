...
Parameter specifications for export and serialisation
...
<small>Inherits: `Generic[ParameterSaveContext_]`</small>

Base class for a parameter representation

### MarkdownRepresentation

<small>Inherits: `Representation[ParameterSaveContext_]`</small>
...
<small>Inherits: `StrRepresentation` `MarkdownRepresentation` `HTMLRepresentation`</small>
...
<small>Inherits: `StrRepresentation` `MarkdownRepresentation`</small>
...
<small>Inherits: `ReprRepr` `HTMLRepresentation`</small>
...
<small>Inherits: `Generic[_T]`</small>
