...
Core classes for optical simulations
...
<small>Inherits: `torch.Tensor`</small>
...
<details open>
<summary className="cursor-pointer font-semibold text-sm py-2">📥 Parameters</summary>
...
<details open>
<summary className="cursor-pointer font-semibold text-sm py-2">📤 Returns</summary>
...
<small>Inherits: `nn.Module`</small>
...
<details>
<summary className="cursor-pointer font-semibold text-sm py-2">⚠️ Raises</summary>
...
<small>Inherits: `Parameter`</small>
